...
#line 11 "..\\RVMDK\\bilang.h"
#line 12 "..\\RVMDK\\bilang.h"
#line 13 "..\\RVMDK\\bilang.h"



extern TimerHandle_t Receive_Timer;
...
void Receive_TimeOut(TimerHandle_t handle);

QueueHandle_t MsgQueue;
QueueHandle_t CmdMsg;
TimerHandle_t Receive_Timer = 0;
static void prvSetupHardware( void );
void TaskA( void *pvParameters );
void TaskB( void *pvParameters );

extern char USART_RX_BUF[64];   
...
int main(void)
{
    ...
    Receive_Timer = xTimerCreate((const char*)"ReceiveTimer",                        20 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ), ( ( BaseType_t ) 0 ), 0, Receive_TimeOut);

	 
    MsgQueue = xQueueGenericCreate( 5, sizeof( int16_t ), ( ( uint8_t ) 0U ) );
	CmdMsg   = xQueueGenericCreate( 5, sizeof( int16_t ), ( ( uint8_t ) 0U ) );
     
    xTaskGenericCreate( ( TaskA ), ( ( signed char * ) "TaskA" ), ( ( ( unsigned short ) 128 ) ), ( 0 ), ( ( ( UBaseType_t ) 0U )+3 ), ( 0 ), ( 0 ), ( 0 ) );

    xTaskGenericCreate( ( TaskB ), ( ( signed char * ) "TaskB" ), ( ( ( unsigned short ) 128 ) ), ( 0 ), ( ( ( UBaseType_t ) 0U )+4 ), ( 0 ), ( 0 ), ( 0 ) );
...
void Receive_TimeOut(TimerHandle_t handle) 
{
	...
	index_receive = 0;
	memset(USART_RX_BUF,0,64*sizeof(char));
    return;
}

#line 111 "..\\User\\main.c"
...
void TaskA( void *pvParameters )
{
    ...
    for( ;; )
    {
        ...
        xQueueGenericSend( ( MsgQueue ), ( ( void* )&SendNum ), ( 0 ), ( ( BaseType_t ) 0 ) );
        SendNum++;
    }
}
...
void TaskB( void *pvParameters )
{
    ...
    for( ;; )
    {
        ...
        if( xQueueGenericReceive( ( MsgQueue ), ( &ReceiveNum ), ( 100/( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) ), ( ( BaseType_t ) 0 ) ) == ( ( ( BaseType_t ) 1 ) ))
        {
